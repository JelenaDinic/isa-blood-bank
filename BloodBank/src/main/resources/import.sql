...
insert into registered_users (blood_type, profession, profession_info, id) values (3, 'Engineer', 'dunno', 2009);
insert into registered_users (blood_type, profession, profession_info, id) values (6, 'Engineer', 'nzm', 2010);
