...
insert into appointments (id, user_id, date_time, duration, status, blood_bank_center_id, is_scheduled, is_cancelled) values (2020, null, '2023-01-04 14:15:00', 30, 6, 2006, false, false);
insert into appointments (id, user_id, date_time, duration, status, blood_bank_center_id, is_scheduled, is_cancelled) values (2021, 2010, '2022-12-29 14:15:00', 30, 0, 2006, true, false);
...
insert into appointments (id, user_id, date_time, duration, status, blood_bank_center_id, is_scheduled, is_cancelled) values (2023, 2009, '2022-12-20 11:00:00', 30, 1, 2006, true, false);
insert into appointments (id, user_id, date_time, duration, status, blood_bank_center_id, is_scheduled, is_cancelled) values (2024, 2010, '2022-12-16 13:00:00', 30, 1, 2006, true, false);
insert into appointments (id, user_id, date_time, duration, status, blood_bank_center_id, is_scheduled, is_cancelled) values (2025, null, '2023-12-19 9:30:00', 30, 6, 2006, false, false);
...
insert into appointments (id, user_id, date_time, duration, status, blood_bank_center_id, is_scheduled, is_cancelled) values (2027, 2009, '2023-01-02 9:30:00', 30, 0, 2006, true, false);
insert into appointments (id, user_id, date_time, duration, status, blood_bank_center_id, is_scheduled, is_cancelled) values (2028, 2009, '2023-01-08 15:15:00', 30, 0, 2006, true, false);
insert into appointments (id, user_id, date_time, duration, status, blood_bank_center_id, is_scheduled, is_cancelled) values (2029, 2010, '2023-01-08 13:30:00', 30, 0, 2006, true, false);
...
insert into complaints (id, text, center_id, staff_id, user_id) values (2040, 'Odvratno osoblje', null, 2011, 2010);
insert into complaints (id, text, center_id, staff_id, user_id) values (2041, 'Sve je neuredno i neorganizovano', 2006, null, 2010);
